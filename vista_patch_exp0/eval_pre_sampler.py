...
def LAI_period_sampler(season, chosen_crop_types):
    ...
    filepaths = glob.glob('./dataset/france2/processed_lai_npy2/*.tif')
    filepaths.sort()
    ...
    labels = np.load('./storage/full_mast1/vista_labes_aligned.npy').astype(np.uint8)
